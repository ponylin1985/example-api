...
export class PatientController {
   ...
   * @param patientService - The patient service for business logic.
   */
  ...
  getPatientsAsync = async (req: Request, res: Response) => {
    ...
    const startTime = req.query.startTime ? DateUtils.parseUtc(req.query.startTime as string) : undefined;
    const endTime = req.query.endTime ? DateUtils.parseUtc(req.query.endTime as string) : undefined;
